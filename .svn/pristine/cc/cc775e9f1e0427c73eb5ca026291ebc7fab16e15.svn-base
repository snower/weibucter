...
class CI_Upload {
	...
	protected $_file_name_override	= '';
        ...
        protected $sae_storage_name;
        protected $sae_storage_file;
        /**
	 * Constructor
	 *
	 * @access	public
	...
	// Is $_FILES[$field] set? If not, no reason to continue.
		...
		if ( ! @copy($this->file_temp, $this->upload_path.$this->file_name))
		{
			if ( ! @move_uploaded_file($this->file_temp, $this->upload_path.$this->file_name))
			{
                 ...
                 * 
                 */
                $this->temp_file_data = file_get_contents($this->file_temp);
                $write_state = s_writefile( $this->upload_path.'/'.$this->file_name, $this->temp_file_data);
                if($write_state === false){
                    return FALSE;
                }
                $this->sae_storage_fileurl = s_get_url( $this->upload_path.'/'.$this->file_name );
                /*
		...
		$this->set_image_properties($this->upload_path.$this->file_name);
                 * 
                 */
                $this->set_image_properties( s_get_wrappers_bypath( $this->upload_path.'/'.$this->file_name) );
